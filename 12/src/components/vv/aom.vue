<template>
  <div class="nn">
     ...
     <div class="num-tow">
      ...
      <!-- <div class="footer">
         <ul>
           <li><router-link to="/">跳到hello1</router-link></li>
           <li><router-link to="/aa">外卖</router-link></li>
           <li><router-link to="/aom">3</router-link></li>
...
// 　　   }
  ...
  mounted(){
    ...
    // this.axios.get("http://elm.cangdu.org/v2/pois/"+geohash).then((res)=>{
  ...
  methods:{
    ...
    food(id){
      this.$router.push({path:"/food",query:{geohash:this.geohash,id:this.id,title:this.title}})
    }
